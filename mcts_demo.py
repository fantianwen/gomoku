...
player1 = PureMCTSPlayer(Board.kPlayerBlack, name="AI 1",weight_c=5, compute_budget=30000)
# player1 = HumanPlayer(Board.kPlayerBlack, name="player 1")

player2 = PureMCTSPlayer(Board.kPlayerWhite, name="AI 2", weight_c=5, compute_budget=30000)
